...
const Test = () => {
    return (
        <>
            ...
            <p>
                This privacy notice for Azurite ("we," "us," or "our"), describes how and
                why we might collect, store, use, and/or share ("process") your information
                when you use our services ("Services"), such as when you:
            </p>
            <ul>
                <li>
                Visit our website at{" "}
                <a href="https://azurite.abstractmelon.net" target="_blank">
                    https://azurite.abstractmelon.net
                </a>
            ...
            <p>
                ...
                <a href="mailto:support@abstractmelon.net">support@abstractmelon.net</a>.
            </p>
            ...
            <ul>
                ...
                is by visiting{" "}
                <a href="https://azurite.abstractmelon.net/data" target="_blank">
                    https://azurite.abstractmelon.net/data
                </a>
            ...
            <p>
                ...
                <a href="#full-privacy-notice">Review the privacy notice in full</a>.
            </p>
            ...
            <ol className="toc">
                ...
                <li>
                <a href="#how-do-we-handle-your-social-logins">
            ...
            <p>
                ...
                your Facebook, X, or other social media account. If you choose to register
                in this way, we will collect certain profile information about you from the
            ...
            <ul>
                ...
                process your information to administer prize draws and competitions.
                </li>
                <li>
                <strong>
                ...
                We may process your information to evaluate and improve our Services,
            ...
            <p>
                ...
                to do so under applicable law, like with your consent, to comply with laws,
            ...
            <ul>
                ...
                to this <a href="https://policies.google.com/privacy">link</a>. We obtain
                ...
                distributed outside the Services in perpetuity. Similarly, other users
                ...
                advertisers to offer virtual currency, gifts, or other items to users in
                return for the acceptance and completion of an advertisement offer. Such
                an offer wall may appear in our application(s) and be displayed to you
                based on certain data, such as your geographic area or demographic
                information. When you click on an offer wall, you will be brought to an
                external website belonging to other persons and will leave our
                application(s). A unique identifier, such as your user ID, will be shared
                with the offer wall provider to prevent fraud and properly credit your
                account with the relevant reward. Please note that we do not control
                third-party websites and have no responsibility in relation to the content
                of such websites. The inclusion of a link towards a third-party website
                does not imply endorsement by us of such website. Accordingly, we do not
                make any warranties regarding such websites or any information, software,
            ...
            <p>
                ...
                <a href="mailto:privacy@myapp.com">privacy@myapp.com</a>.
            </p>
            <h3 id="what-are-your-privacy-rights">9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
            <p>
                <strong>In Short:</strong> You may review, change, or terminate your account
                at any time.
            </p>
            <p>
            ...
            <p>
                ...
                us at <a href="mailto:privacy@myapp.com">privacy@myapp.com</a>.
            </p>
            ...
            <p>
                ...
                <a href="mailto:privacy@myapp.com">privacy@myapp.com</a>, or by referring to
            ...
            <p>
                MyApp has not disclosed, sold, or shared any personal information to third
                parties for a business or commercial purpose in the preceding twelve (12)
                months. MyApp will not sell or share personal information in the future
            ...
            <ul>
                ...
                shared, or disclosed for a business purpose; and
                </li>
                <li>
            ...
            <p>
                ...
                <a href="mailto:privacy@myapp.com">privacy@myapp.com</a>, or by referring to
                the contact details at the bottom of this document. If you have a complaint
            ...
            <p>
                ...
                <a href="mailto:privacy@myapp.com">privacy@myapp.com</a> or by post to:
            </p>
            <p>
                MyApp
                <br />
            ...
            <p>
                ...
                clicking <a href="https://www.myapp.com/data-request">here</a>.
            </p>
            </div>
        </>
    );
