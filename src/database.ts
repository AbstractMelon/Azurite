        ...
        files.forEach((file) => {
            ...
            if (stats.isFile() && path.extname(file) === ".json") {
                const modData = JSON.parse(
                    fs.readFileSync(modFilePath, "utf-8"),
                );
                mods.push(modData);
...
export function initializeDatabase(): void {
    ...
    const gamesData: GameData[] = [
        ...
        },
        {
            name: "Muck",
            description:
                "Collect resources, craft tools, weapons, & armor, find items & build your base during day. But once night falls, mysterious enemies appear from the shadows.",
            id: "muck",
        ...
        },
        {
            name: "Ultrakill",
            description:
                "A fast-paced ultraviolent old school FPS that fuses together classic shooters like Quake, modern shooters like Doom (2016) and character action games like Devil May Cry.",
            id: "ultrakill",
