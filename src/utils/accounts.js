...
function createAccount(username, password, bio = "", email = "", isAdmin = false, gamesModded = [], profilePicture = "", socialLinks = {}, favoriteGames = [], moddingExperience = "", dateCreated = new Date()) {
    const accountData = {
        username,
        password, 
        bio,
