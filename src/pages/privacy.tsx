    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <p>
                    This privacy notice for Azurite ("we," "us," or "our"),
                ...
                <ul>
                    <li>
                        ...
                        <a
                            href="https://azurite.abstractmelon.net"
                            target="_blank"
                        >
                ...
                <p>
                    ...
                    <a href="mailto:support@abstractmelon.net">
                        support@abstractmelon.net
                    </a>
                    .
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <a href="#what-information-do-we-collect">
                            Learn more about personal information you disclose
                            to us
                        </a>
                        .
                    </li>
                    ...
                    <li>
                        ...
                        <a
                            href="https://azurite.abstractmelon.net/data"
                            target="_blank"
                        >
                ...
                <ul>
                    ...
                    <li>
                        ...
                        We may process your information to administer prize
                    ...
                    <li>
                        ...
                        We may process your information to evaluate and improve
                    ...
                    <li>
                        ...
                        obligations, respond to legal requests, and prevent
                        harm.
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Platform APIs (e.g., Google Maps API, Places API). To
                        find out more about Google's Privacy Policy, please
                        refer to this{" "}
                        <a href="https://policies.google.com/privacy">link</a>.
                        We obtain and store on your device ('cache') your
                        location. You may revoke your consent anytime by
                        contacting us at the contact details provided at the end
                        of this document.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        may be publicly distributed outside the Services in
                    ...
                    <li>
                        <strong>Offer Wall.</strong> Our application(s) may
                        display a third-party-hosted "offer wall." Such an offer
                        wall allows third-party advertisers to offer virtual
                        currency, gifts, or other items to users in return for
                        the acceptance and completion of an advertisement offer.
                        Such an offer wall may appear in our application(s) and
                        be displayed to you based on certain data, such as your
                        geographic area or demographic information. When you
                        click on an offer wall, you will be brought to an
                        external website belonging to other persons and will
                        leave our application(s). A unique identifier, such as
                        your user ID, will be shared with the offer wall
                        provider to prevent fraud and properly credit your
                        account with the relevant reward. Please note that we do
                        not control third-party websites and have no
                        responsibility in relation to the content of such
                        websites. The inclusion of a link towards a third-party
                        website does not imply endorsement by us of such
                        website. Accordingly, we do not make any warranties
                        regarding such websites or any information, software, or
                        other products or materials found there, or any results
                ...
                <p>
                    ...
                    <a href="mailto:privacy@myapp.com">privacy@myapp.com</a>, or
                ...
                <p>
                    MyApp has not disclosed, sold, or shared any personal
                    information to third parties for a business or commercial
                    purpose in the preceding twelve (12) months. MyApp will not
                ...
                <p>
                    ...
                    clicking{" "}
                    <a href="https://www.myapp.com/data-request">here</a>.
                </p>
            </div>
        </>
    );
