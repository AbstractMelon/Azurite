...
<svelte:head>
	<title>DMCA Policy - Azurite</title>
	<meta name="description" content="Digital Millennium Copyright Act (DMCA) policy for Azurite mod hosting platform" />
</svelte:head>
...
<div class="min-h-screen bg-background-primary">
	<div class="container mx-auto px-4 py-8 max-w-4xl">
		<div class="card">
			<div class="p-8">
				<h1 class="text-3xl font-bold text-text-primary mb-6">DMCA Policy</h1>
				...
				<div class="prose prose-invert max-w-none space-y-6">
					<section>
						...
						<p class="text-text-secondary leading-relaxed">
							Azurite respects the intellectual property rights of others and expects its users to do the same.
					...
					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Filing a DMCA Notice</h2>
						<p class="text-text-secondary leading-relaxed mb-4">
							If you believe that your copyrighted work has been copied in a way that constitutes copyright
							infringement and is accessible via our service, please notify our designated copyright agent
					...
					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Designated Copyright Agent</h2>
						<p class="text-text-secondary leading-relaxed mb-4">
						...
						<div class="bg-background-secondary p-4 rounded-lg border border-slate-600">
							<p class="text-text-primary"><strong>DMCA Agent</strong></p>
							<p class="text-text-secondary">Azurite Platform</p>
							<p class="text-text-secondary">Email: dmca@azurite.dev</p>
							<p class="text-text-secondary">Subject Line: "DMCA Takedown Notice"</p>
						</div>
					</section>

					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Counter-Notification</h2>
						<p class="text-text-secondary leading-relaxed mb-4">
							If you believe that material you posted was removed or access to it was disabled by mistake
							or misidentification, you may file a counter-notification with us by providing the following information:
						</p>
						<ul class="list-disc pl-6 space-y-2 text-text-secondary">
					...
					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Repeat Infringer Policy</h2>
						<p class="text-text-secondary leading-relaxed">
					...
					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Processing Time</h2>
						<p class="text-text-secondary leading-relaxed">
							We will process all valid DMCA notices as quickly as possible, typically within 24-48 hours of receipt.
							Upon receiving a valid takedown notice, we will:
						</p>
						<ul class="list-disc pl-6 space-y-2 text-text-secondary mt-4">
					...
					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">False Claims</h2>
						<p class="text-text-secondary leading-relaxed">
							...
							We reserve the right to seek damages from any party that submits a false DMCA notice.
						</p>
					</section>

					<section>
						<h2 class="text-2xl font-semibold text-text-primary mb-4">Questions</h2>
						<p class="text-text-secondary leading-relaxed">
							If you have any questions about this DMCA policy or need assistance with filing a notice,
							please contact us at <a href="mailto:dmca@azurite.dev" class="text-primary-400 hover:text-primary-300 transition-colors">dmca@azurite.dev</a>.
						</p>
					</section>
				</div>
			</div>
