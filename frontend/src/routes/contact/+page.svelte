...
<svelte:head>
	...
	<meta
		name="description"
		content="Get in touch with the Azurite team for support, feedback, or business inquiries"
	/>
</svelte:head>
				...
				<div class="card">
					<div class="p-8 text-center">
						...
						<div class="flex gap-4 justify-center">
							<button onclick={resetForm} class="btn btn-outline"> Send Another Message </button>
		...
		{:else}
			...
			<div class="text-center mb-8">
				...
				<p class="text-text-secondary text-lg max-w-2xl mx-auto">
					Have a question, suggestion, or need support? We'd love to hear from you. Our team is here
					to help make your Azurite experience better.
				</p>
			</div>
					...
					<div class="card">
						<div class="p-6">
							...
							<div class="space-y-3">
								<a
									href="/help"
									class="flex items-center gap-2 text-text-secondary hover:text-primary-400 transition-colors"
								>
									<span>📚</span>
						...
						<div class="p-8">
							...
							<form onsubmit={handleSubmit} class="space-y-6">
								...
								<div class="flex gap-4">
									...
									<a href="/help" class="btn btn-outline"> Check Help Center First </a>
								</div>
							</form>
						</div>
					</div>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div>
								<h3 class="font-semibold text-text-primary mb-2">
									How long does mod approval take?
								</h3>
								<p class="text-text-secondary text-sm">
									Most mods are reviewed within 24-48 hours. Complex mods or those requiring
							...
							<div>
								<h3 class="font-semibold text-text-primary mb-2">
									Can I update my mod after approval?
								</h3>
								<p class="text-text-secondary text-sm">
							...
							<div>
								...
								<p class="text-text-secondary text-sm">
									Yes! We provide a REST API for developers. Check our documentation for details on
